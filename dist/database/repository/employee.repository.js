...
let EmployeeRepo = class EmployeeRepo extends typeorm_1.Repository {
    getallEmployesswhotreatedPatient(id) {
        return __awaiter(this, void 0, void 0, function* () {
            const qb = yield this.createQueryBuilder('employee')
...
EmployeeRepo = __decorate([
    (0, typeorm_1.EntityRepository)(employee_model_1.Employee)
], EmployeeRepo);
