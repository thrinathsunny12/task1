...
const jobtype_service_1 = require("@service/jobtype.service");
class JobtypeController {
    constructor() {
         ...
         * @returns void
         */
        this.createJobtype = (req, res) => __awaiter(this, void 0, void 0, function* () {
            const { body: { name, description }, } = req;
            const response = yield this.jobtypeService.create(name, description);
            this.responseParser
                .setStatus(true)
        ...
        this.jobtypeService = new jobtype_service_1.JobtypeService();
    }
}
exports.JobtypeController = JobtypeController;
//# sourceMappingURL=jobtype.controller.js.map